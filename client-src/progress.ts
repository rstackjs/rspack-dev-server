...
export function isProgressSupported(): boolean {
  return (
    'customElements' in self && Boolean(HTMLElement.prototype.attachShadow)
  );
}

export function defineProgressElement(): void {
  ...
  class WebpackDevServerProgress extends HTMLElement {
    ...
    reset() {
      ...
      (this.shadowRoot as ShadowRoot).innerHTML = innerHTML;
    ...
    update(percent: number): void {
      ...
      const element = shadowRoot.querySelector('#progress') as HTMLElement;
      if (this.type === 'circular') {
        const path = shadowRoot.querySelector('path') as SVGPathElement;
        const value = shadowRoot.querySelector('#percent-value') as HTMLElement;
